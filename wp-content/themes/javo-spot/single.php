				...
				<div class="jv-single-post-meta-wrap">
					<div class="jv-single-post-meta-avatar javo-spyscroll-icon">
						<a href="#jv-single-author-title">
							<?php echo get_avatar( $jvfrm_spot_author->ID, 40 ); ?>
						</a>
					</div>
					...
					<ul class="jv-single-post-author-info-wrap">
						<li class="meta-author-name">
							...
							<?php esc_html_e( 'by', 'javospot' ); ?>
							<a href="<?php echo esc_url( home_url('member/'.$jvfrm_spot_author->user_login ) ); ?>">
								<?php echo esc_html( $jvfrm_spot_author->display_name ); ?></a> -
...
<div class="container">
	<div class="row">
		<?php
		switch( get_post_meta( get_the_ID(), 'jvfrm_spot_sidebar_type', true ) ) :
			case 'full' :
