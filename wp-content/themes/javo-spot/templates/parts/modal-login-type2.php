	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content no-padding">
			...
			<div class="modal-body">
				<form action="<?php echo wp_login_url(apply_filters('jvfrm_spot_modal_login_redirect', '')  ); ?>" id="login_form" name="login_form" method="post">
					<div class="row">
					...
					<div class="row bottom_row">
						...
						<div class="col-md-12 col-xs-12">
							<?php if( get_option( 'users_can_register' ) ) : ?>
								<small>
									<?php esc_html_e("Don't have an account?", 'javospot');?>
									<a href="#" data-toggle="modal" data-target="#register_panel" class="required"><?php esc_html_e('Sign Up', 'javospot');?></a>
								</small>
							<?php else: ?>
								<div class="well well-sm">
									<small><?php esc_html_e("This site is not allowed new members. please contact administrator.", 'javospot');?></small>
								</div>
							<?php endif; ?>
						</div>
						<div class="col-md-12 col-xs-12">
							<small class="description"><?php esc_html_e("Your privacy is important to us and we will never rent or sell your information.", 'javospot');?></small>
						</div>
					</div>
