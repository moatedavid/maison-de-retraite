...
<div class="wrap about-wrap" id="jv-default-setting-plugins-wrap">
	<div class="feature-section theme-browser rendered">
		<?php
			foreach( $plugins as $plugin ):
				...
				//$plugin_action = jvfrm_spot_admin_helper::$instance->plugin_link( $plugin );
			...
			<div class="theme <?php echo sanitize_html_class( $plugin['slug'] ) . ' ' . sanitize_html_class( $class ); ?>">
					...
					<?php
						...
						if( $plugin['required'] ): ?>
							<div class="plugin-required">
								<?php esc_html_e( 'Required', 'javospot' ); ?>
							</div>
						<?php
						endif;
					?>
				...
				<?php if( isset( $plugin_action['update'] ) && $plugin_action['update'] ): ?>
					<div class="theme-update">
						<?php esc_html_e( "Update Available:", 'javospot' ); ?>
						<?php esc_html_e( "Version", 'javospot' ); ?>
	...
	<div class="spinner-wrap">
		...
		<span class="spinner-text"><?php esc_html_e( "Processing...", 'javospot' ); ?></span>
	</div>
</div>
