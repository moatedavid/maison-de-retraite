<?php
class Jvfrm_Spot_Single_Post_Slider extends WP_Widget
{
	...
	public function __construct(){
		...
		parent::__construct(
			get_class( $this ),
			esc_html__( "[JAVO] Featured Item Slider", 'Lavacode' )
		);
	}
	...
	public function widget( $args=Array(), $instance ){
		...
		if( !class_exists( 'JvfrmSpot_ShortcodeParse' ) )
			return;
	...
	public function form( $instance ){
		...
		$this->addParam(
			Array(
				...
				'label'	=> esc_html__( "Widget Title", 'javospot' ),
			)
		);
	}
}