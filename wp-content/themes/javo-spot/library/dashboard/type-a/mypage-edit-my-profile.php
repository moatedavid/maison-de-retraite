...
function jvfrm_spot_input_str($fdnm, $default){
	global $fields, $edit;
	echo $edit != NULL ? esc_attr( $default ) : (!empty($fields) ? esc_attr( $fields[$fdnm] ) : "") ;
};
...
<div class="jv-my-page">
	...
	<div class="container secont-container-content">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-xs-12 col-sm-10 main-content-right edit_my_profile" id="main-content">
				<div class="row">
					<div class="col-md-12">
										...
										<form method="post" enctype="multipart/form-data">
											...
											<div class="javo-form-div <?php echo empty($edit)?"hidden":"";?>">
												...
												<div class="row">
													...
													<div class="col-xs-12 col-md-9"><input type="text" class="form-control" name="jvfrm_spot_r[user_login]" value="<?php jvfrm_spot_input_str("user_login", (!empty($edit)? $edit->user_login : NULL));?>" data-required placeholder="<?php esc_attr_e('Username', 'javospot');?>" <?php echo (($edit)?"readonly" : "");?>></div>
												</div>
												...
												<div class="javo-register advanced">
													...
													<div class="row">
														...
														<div class="col-xs-12 col-lg-9"><input type="text" class="form-control" name="jvfrm_spot_r[fax]" value="<?php jvfrm_spot_input_str("fax", (!empty($edit)?get_user_meta($edit->ID, "fax", true):null));?>"></div>
													</div>
													<hr>
													<div class="row picture-upload-wrap">
														<div class="col-xs-12 col-md-3"><div class="well well-sm"><?php esc_html_e('Picture', 'javospot') ?></div></div>
														<div class="col-xs-12 col-md-9">
															<div class="row">
													...
													<div class="row">
														...
														<div class="col-xs-12 col-md-9"><?php wp_editor((($edit)? get_user_meta($edit->ID, "description", true) : ""), "javo-propfile-textarea", Array("textarea_name"=>"jvfrm_spot_r[description]", "editor_class"=>"form-control", 'media_buttons' => 0));?></div>
													</div>
