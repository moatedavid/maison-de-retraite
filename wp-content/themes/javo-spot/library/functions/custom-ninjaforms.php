...
function ninja_forms_sidebar_display_lava_get_author_email($field_id, $data, $form_id = ''){
	...
	?>
	<input id="ninja_forms_field_<?php echo sanitize_html_class( $field_id );?>" data-mask="" data-input-limit="" data-input-limit-type="char" data-input-limit-msg="" name="ninja_forms_field_<?php echo $field_id;?>" placeholder="<?php esc_attr_e( "Your email address", 'javospot' ); ?>" class="ninja-forms-field  ninja-forms-req email " value="<?php echo esc_attr( $lava_author_email ); ?>" rel="<?php echo esc_html( $field_id );?>" type="text" style="display:none;">
