;( function( $ ) {
	"use strict";
	var jvfrm_spot_wp_media = function( opt )
	{
		if( ! window.__JAVO_WP_MEDIA__ )
		{
			...
			this.attr = $.extend( true, {}, {
				...
				, input_name			: "jvfrm_spot_detail_images[]"
			}, opt );
	...
	jvfrm_spot_wp_media.prototype = {
		constructor : jvfrm_spot_wp_media
		, init : function ()
		{
			var opt			= this.attr;
			$( document )
	...
	jQuery.jvfrm_spot_wp_media = function(opt){
		new jvfrm_spot_wp_media(opt);
	};
} )( jQuery );