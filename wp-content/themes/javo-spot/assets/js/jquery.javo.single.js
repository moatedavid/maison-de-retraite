( function( window, $, undef ) {
	"use strict";
	var jvfrm_spot_detail_item = function( options )
	{
		var
			opt = $.extend(
				true
	...
	$.jvfrm_spot_single = function( options ) {
		new jvfrm_spot_detail_item( options );
	}
	jvfrm_spot_detail_item.prototype = {
		constructor: jvfrm_spot_detail_item
		, init : function()
		{
