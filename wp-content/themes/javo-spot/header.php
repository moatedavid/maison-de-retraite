...
<?php do_action( 'jvfrm_spot_after_body_tag' );?>
<?php if( defined('ICL_LANGUAGE_CODE') ){ ?>
	<input type="hidden" name="jvfrm_spot_cur_lang" value="<?php echo esc_attr( ICL_LANGUAGE_CODE );?>">
<?php }; ?>
...
<?php do_action( 'jvfrm_spot_output_header', get_the_ID() ); ?>
