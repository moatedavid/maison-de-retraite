...
<div class="javo-maps-search-wrap">
	...
	<div class="javo-maps-advanced-filter-wrap">
		...
		<?php do_action( 'jvfrm_spot_map_template_filter_inner' ); ?>
	...
	<div class="row javo-map-box-advance-filter-wrap">
		...
		<div class="col-md-2 col-sm-6">
			<button class="btn btn-default admin-color-setting btn-block" id="javo-map-box-advance-filter-reset">
				...
				<span class="txt-reset"><?php esc_html_e( "Reset", 'javospot' );?></span>
			</button>
		</div><!-- /.col-md-2 -->
		<div class="col-md-7 col-sm-12">
			<div class="row">
				...
				<div class="col-md-5 col-sm-12 text-right">
					<span class="javo-map-filter-result-count" data-suffix="<?php esc_attr_e( "Listing(s)", 'javospot' ); ?>"></span>
				</div>
			</div>
		</div>
	</div>
	<?php do_action( 'jvfrm_spot_map_box_append_filter_after' ); ?>
	<!-- /.row -->
</div>
<!-- javo-maps-search-wrap -->
<!-- Control & Filter Area Close -->
<input type="hidden" name="jvfrm_spot_is_search" value="<?php echo isset( $_POST['filter'] );?>">