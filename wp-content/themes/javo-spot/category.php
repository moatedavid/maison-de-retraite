...
$strModuleName		= get_option( 'jvfrm_spot_term_' . $term_id . '_module' );
$intExcerptLength	= get_option( 'jvfrm_spot_term_' . $term_id . '_module_length' );
$intExcerptColumns	= get_option( 'jvfrm_spot_term_' . $term_id . '_module_columns' );
...
<header class="archive-header">
	<h3 class="archive-title">
		...
		<small><?php esc_html_e( "Archive", 'javospot' );?></small>
		<i><?php echo wp_kses( category_description(), jvfrm_spot_allow_tags() ); ?></i>
	</h3>
		...
		<section id="primary" class="site-content">
			<div id="content" role="main">
				...
				if ( have_posts() )	{
					...
					jvfrm_spot_content_nav( 'nav-below' );
				}else{
