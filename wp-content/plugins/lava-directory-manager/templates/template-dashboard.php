...
global
	...
	, $lava_directory_stc_mmypage
	, $lava_directory_manager_func;

$lava_directory_status			= Array( 'publish' );

if( ! $lava_directory_stc_mmypage->get( 'hide_pending', false ) || current_user_can( 'manage_options' ) )
	$lava_directory_status[]		= 'pending';
...
$lava_user_posts						= new WP_Query(
	Array(
		...
		, 'post_status'					=> $lava_directory_status
		, 'posts_per_page'			=> 10
						...
						<td>
							...
							<?php if( get_current_user_id() == get_the_author_meta( 'ID' ) ) : ?>
								<div class="lava-action">
									...
									<a href="<?php lava_directory_edit_page(); ?>">
										<?php _e( "Edit", 'Lavacode' ); ?>
									</a>
									<a href="javascript:" data-lava-directory-manager-trash="<?php the_ID();?>">
