...
class Lava_Directory_Manager_Submit
{
	...
	{
		$this->post_type = constant( 'Lava_Directory_Manager_Func::SLUG' );
		$this->name = constant( 'Lava_Directory_Manager_Func::NAME' );
		...
		if(
			isset( $_POST[ 'lava_directory_manager_mypage_delete' ] ) &&
			wp_verify_nonce( $_POST['lava_directory_manager_mypage_delete'], 'security' )
		) $this->remove();
	}
