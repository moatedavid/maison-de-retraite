...
class Lava_Directory_Manager_Addons
{
	...
	public function __construct()
	{
		...
		add_action( 'upgrader_process_complete', Array( $this, 'plugin_update_complete' ) );
	...
	{
		$license_actAddons = 'lava-directory-favorite';
		...
		if( 'plugin_information' == $action ) :
			 if ( isset( $args->slug ) && $args->slug == plugin_basename( $license_actAddons . '/' . $license_actAddons . '.php' ) )
			{
				...
				$addonMeta->download_link	= 'http://lava-code.com/directory/?download_file=109&order=wc_order_5631641a18b12&email=javothemes@gmail.com&key=2a294b65f721d8c08d014d823e235111';
