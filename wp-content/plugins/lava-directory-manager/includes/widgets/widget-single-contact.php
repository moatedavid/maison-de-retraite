...
class Lava_Contact_Single_Page extends WP_Widget
{
	...
	function __construct()
	{
		parent::__construct(
			...
			, array( 'description' => __( "This is for only single detail pages. This widget shows the requested information about the author of the item.", 'Lavacode' ) )
		);
	...
	public function widget( $args, $instance )
	{
		...
		if(
			! $template_file = locate_template(
				Array(
					$output_filename
					, "{$lava_directory_manager->folder}/{$output_filename}"
				)
			)
		){
