...
class Lava_Directory_Manager_Shortcodes
{
	...
	public function _form_enqueues() {
		...
		wp_enqueue_script( 'lava-directory-manager-scripts-js' );
		wp_enqueue_script( 'lava-directory-manager-lava-submit-script-js' );
	}
...
new Lava_Directory_Manager_Shortcodes;