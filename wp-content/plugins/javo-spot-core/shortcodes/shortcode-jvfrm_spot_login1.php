<?php
class jvfrm_spot_login1 extends JvfrmSpot_ShortcodeParse
{
	...
	public function initialize()
	{
		...
		if( function_exists( 'jvfrm_spot_getCurrentUserPage' ) ) {
			$this->mypage		= jvfrm_spot_getCurrentUserPage();
			$this->editProfile = jvfrm_spot_getCurrentUserPage( 'edit-my-profile' );
			$this->submit_item	= jvfrm_spot_getCurrentUserPage( 'add-lv_listing');
		}
