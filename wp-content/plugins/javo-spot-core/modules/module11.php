...
class module11 extends Jvfrm_Spot_Module
{
	...
	public function output()
	{
		...
		<div <?php $this->classes( 'panel panel-default panel-no-radius' ); ?>>
			...
			<div class="row">
				<div class="col-md-12">
				<div class="thum">
					<a href="<?php echo $this->permalink; ?>" class="jv-image-gradient jv-big-grid-overlay"><?php echo $this->thumbnail( 'jvfrm-spot-box-v', false ); ?></a>
